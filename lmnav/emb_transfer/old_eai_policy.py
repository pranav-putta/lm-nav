...
from aj3.emb_transfer.sensors import ImageGoalRotationSensor
from aj3.emb_transfer.transforms import get_transform
from aj3.emb_transfer.util import load_encoder
from aj3.emb_transfer.visual_encoder import VisualEncoder
...
class EAINet(Net):
    def __init__(
        ...
        # goal embedding
        if 'instance_imagegoal' in observation_space.spaces:
            imagegoalrotation_sensor_shape = observation_space.spaces['instance_imagegoal'].shape
