...
#SBATCH --output logs/train-ppo-5.out
#SBATCH --error logs/train-ppo-5.err
#SBATCH --gpus a40:4
#SBATCH --nodes 1
...
torchrun --standalone --nnodes=1 --nproc_per_node=4 lmnav/ppo_train.py train/nav_llama/1env_karmesh/rl/lora+clip+karmesh+5 --resume_run_id u4628bl7
